            ...
            switch (pilih) {
                ...
                case '4':
                    ...
                    for(int i = 0; i<ListHewan.size();i++){
                        ...
                        System.out.println("Jenis = "+ ListHewan.get(i).jenis);
                        System.out.println("Nama = "+ ListHewan.get(i).nama);
                        System.out.println("Habitat = "+ ListHewan.get(i).habitat);
                        System.out.println("Umur = "+ ListHewan.get(i).umur);
                        System.out.println("-".repeat(10));
                    }
                    break;
